        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_PT = table.Column<string>(nullable: true),
                    Initials = table.Column<string>(nullable: true),
                    Bacen = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Facilitie_Customer_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificOff", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecificOff_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tag_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkDay_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IBGECode = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkDayTimeOff", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkDayTimeOff_WorkDay_WorkDayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecificOff_CustomerId",
                table: "SpecificOff",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkDay_CustomerId",
                table: "WorkDay",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkDayTimeOff_WorkDayId",
                table: "WorkDayTimeOff",
                column: "WorkDayId");
        }
